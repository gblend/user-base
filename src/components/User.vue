<template>
  ...
  <div class="self-center pl-3 sm:pl-6 lg:pl-0.5">
    ...
    <div class="flex w-full py-2 lg:py-0 -ml-5">
      ...
      <div class="w-full flex flex-col sm:text-left mt-2.5">
        <div class="space-y-2">
          <p class="text-xl text-cst_primary-400 font-semibold tracking-wider">
            Mrs. Shalom Chioma
            <span class="font-light opacity-60 ml-4">25</span>
          </p>
          <p
        ...
        >
          ...
          <span class="flex space-x-0.5 lg:space-x-1 text-cst_gray-200">
            ...
            <span class="lg:text-sm text-cst_black opacity-30"
              >011-962-7516</span
            >
          </span>
          <div
          ...
          >
            <span
              class="space-x-1 lg:space-x-1 flex justify-between items-center lg:text-base mt-2"
            >
              <i class="fas fa-mobile-alt text-cst_gray-400 lg:text-sm"> </i>
              <p
                class="font-light sm:text-lg text-cst_black opacity-40 lg:tracking-tighter"
              >
                011-962-7516
              </p>
            </span>
